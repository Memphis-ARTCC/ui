...
export const AuthProvider = (props: AuthContextProps) => {
    ...
    const isLoggedIn = () => {
        return window.localStorage.getItem("accessToken") !== null && (user?.isMember ?? false);
    };
    ...
    return (
        <AuthContext.Provider value={{ user, setUser, logout, isLoggedIn, isMember, hasRole, isStaff, isFullStaff, isSeniorStaff, isTrainingStaff, isSeniorTrainingStaff }}>
            {props.children}
